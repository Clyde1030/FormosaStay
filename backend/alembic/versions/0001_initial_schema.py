...
def downgrade() -> None:
    ...
    # Note: uq_active_lease_per_room index doesn't exist in initial schema (status is calculated)
    ...
    # Note: lease_status ENUM type doesn't exist in initial schema (status is calculated dynamically)
